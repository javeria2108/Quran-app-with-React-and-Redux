...
import { fetchRecitersListFailure, fetchRecitersListRequest, fetchRecitersListSuccess } from '../actions/fetchRecitersListActions';
...
export const fetchRecitersList = () => {
  return async (dispatch) => {
    ...
    try {
      ...
      dispatch(fetchRecitersListFailure(`Error fetching reciters:${error.message}`));
    }
  };
};
